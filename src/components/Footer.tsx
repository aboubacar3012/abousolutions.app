...
export default function Footer() {
  ...
  const footerLinks = {
    services: [
      ...
      { name: 'Services MVP', href: '/#mvp' },
      { name: 'Développement sur mesure', href: '/services' },
      { name: 'Conception UI/UX', href: '/services#design' }
    ],
    resources: [
      { name: 'Blog', href: '/blog' },
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 pb-10">
          ...
          >
            <Link href="/" className="flex items-center mb-4">
              <motion.div
                ...
                animate={{
                  boxShadow: [
                    "0 0 0 0 rgba(77, 192, 255, 0)",
                    "0 0 0 10px rgba(77, 192, 255, 0.2)",
                    "0 0 0 0 rgba(77, 192, 255, 0)"
                  ]
                }}
                transition={{
              ...
              <span className="text-xl font-bold ml-2 blue-gradient-text">AbouSolutions</span>
            </Link>
            
            <p className="text-foreground-dark/70 mb-6">
              Solutions numériques sur mesure pour startups et PME. Templates modernes et création de MVP pour accélérer votre développement.
            </p>
            ...
            <div className="flex space-x-4">
              {footerLinks.social.map((item) => (
                <motion.a
                  ...
                  className="text-foreground-dark/60 hover:text-accent transition-colors"
                  whileHover={{ 
                    scale: 1.2,
                    rotate: [0, 5, -5, 0],
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-lg font-semibold mb-6 text-foreground-dark gradient-border inline-block pb-2 pr-4">
              Services
            </h3>
            <ul className="space-y-3">
              {footerLinks.services.map((link, index) => (
                ...
                >
                  <Link
                    href={link.href}
                    className="text-foreground-dark/70 hover:text-accent transition-colors relative group flex items-center"
                  >
                    <motion.span 
                      className="absolute left-0 w-0 h-[1px] bg-accent group-hover:w-full transition-all duration-300"
                      initial={{ width: 0 }}
